...
python ${DIR_CODE}/tree.of.life.filter.py -o virus ${SAMPLE}.virus.megahit.contigs.BLAST.house.format.csv test/toy.example.virus.megahit.contigs.SV.csv test5
