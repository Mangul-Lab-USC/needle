...
python ../tree.of.life.filter.py Sample_TZHZ505.Aligned.out_after_rRNA.fasta.virus.megahit.contigs.BLAST.house.format.csv Sample_TZHZ505.Aligned.out_after_rRNA.fasta.virus.megahit.contigs.SV.csv Sample_TZHZ505.virus.filtered.csv
